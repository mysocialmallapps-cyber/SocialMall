    ...
    <div className="min-h-screen bg-white text-zinc-900">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 pb-16 pt-12 sm:px-6 lg:px-8 lg:pt-16">
        <section className="mx-auto flex w-full max-w-3xl flex-col items-center gap-6">
          ...
          <div className="w-full rounded-[2rem] border border-zinc-100 bg-white p-2 shadow-[0_18px_40px_-24px_rgba(0,0,0,0.3)]">
            <input
              type="text"
        ...
        <section className="grid grid-cols-2 gap-x-4 gap-y-8 md:grid-cols-4 md:gap-x-6 md:gap-y-10">
